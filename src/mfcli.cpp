...
int main(int argc, char* argv[])
{
    ...
    if (argc <= first) { std::cerr << "Usage: mfcli [--socket path] peers|streams|register|catalog-query|catalog-show <peer-id>|invite|bye <catalog-device-id>" << std::endl; return 1; }
